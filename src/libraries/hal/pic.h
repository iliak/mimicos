...
extern UBYTE pic_read_data(UBYTE picNum);

// Send a data byte to pic
extern void pic_send_data(UBYTE data, UBYTE picNum);

// Send operational command to pic
extern void pic_send_command(UBYTE cmd, UBYTE picNum);

// enables and disables interrupts
extern void pic_mask_irq(UBYTE irqmask, UBYTE picNum);

// Initialize pic
extern void pic_initialize(UBYTE base0, UBYTE base1);
