...
#define AN_SemCorrupt		0x01000008	// A semaphore is in an illegal state at ReleaseSemaphore() 
...
#define AN_MemoryInsane 	0x0100000C	// Sanity check on memory list failed during AvailMem(MEMF_LARGEST) 
...
#define AN_BadFreeAddr		0x0100000F	// Memory header not located. [ Usually an invalid address passed to FreeMem() ] 
#define	AN_BadSemaphore		0x01000010	// An attempt was made to use the old message semaphores. 
#define AN_PageFault		0x01000011	// Page fault error
